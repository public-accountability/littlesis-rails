...
ActiveRecord::Schema.define(version: 20170427180140) do
  ...
  add_index "relationship", ["entity1_id", "entity2_id", "updated_at"], name: "updated_e1_e2_idx", using: :btree
  ...
  add_index "relationship", ["updated_at"], name: "updated_at_indx_test", using: :btree
