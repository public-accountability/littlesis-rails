...
AddressState.create!([
                       {id: 1, name: "Alaska", abbreviation: "AK", country_id: 1},
                       {id: 2, name: "Alabama", abbreviation: "AL", country_id: 1},
                       {id: 3, name: "American Samoa", abbreviation: "AS", country_id: 1},
                       {id: 4, name: "Arizona", abbreviation: "AZ", country_id: 1},
                       {id: 5, name: "Arkansas", abbreviation: "AR", country_id: 1},
                       {id: 6, name: "California", abbreviation: "CA", country_id: 1},
                       {id: 7, name: "Colorado", abbreviation: "CO", country_id: 1},
                       {id: 8, name: "Connecticut", abbreviation: "CT", country_id: 1},
                       {id: 9, name: "Delaware", abbreviation: "DE", country_id: 1},
                       {id: 10, name: "District of Columbia", abbreviation: "DC", country_id: 1},
                       {id: 11, name: "Federated States of Micronesia", abbreviation: "FM", country_id: 1},
                       {id: 12, name: "Florida", abbreviation: "FL", country_id: 1},
                       {id: 13, name: "Georgia", abbreviation: "GA", country_id: 1},
                       {id: 14, name: "Guam", abbreviation: "GU", country_id: 1},
                       {id: 15, name: "Hawaii", abbreviation: "HI", country_id: 1},
                       {id: 16, name: "Idaho", abbreviation: "ID", country_id: 1},
                       {id: 17, name: "Illinois", abbreviation: "IL", country_id: 1},
                       {id: 18, name: "Indiana", abbreviation: "IN", country_id: 1},
                       {id: 19, name: "Iowa", abbreviation: "IA", country_id: 1},
                       {id: 20, name: "Kansas", abbreviation: "KS", country_id: 1},
                       {id: 21, name: "Kentucky", abbreviation: "KY", country_id: 1},
                       {id: 22, name: "Louisiana", abbreviation: "LA", country_id: 1},
                       {id: 23, name: "Maine", abbreviation: "ME", country_id: 1},
                       {id: 24, name: "Marshall Islands", abbreviation: "MH", country_id: 1},
                       {id: 25, name: "Maryland", abbreviation: "MD", country_id: 1},
                       {id: 26, name: "Massachusetts", abbreviation: "MA", country_id: 1},
                       {id: 27, name: "Michigan", abbreviation: "MI", country_id: 1},
                       {id: 28, name: "Minnesota", abbreviation: "MN", country_id: 1},
                       {id: 29, name: "Mississippi", abbreviation: "MS", country_id: 1},
                       {id: 30, name: "Missouri", abbreviation: "MO", country_id: 1},
                       {id: 31, name: "Montana", abbreviation: "MT", country_id: 1},
                       {id: 32, name: "Nebraska", abbreviation: "NE", country_id: 1},
                       {id: 33, name: "Nevada", abbreviation: "NV", country_id: 1},
                       {id: 34, name: "New Hampshire", abbreviation: "NH", country_id: 1},
                       {id: 35, name: "New Jersey", abbreviation: "NJ", country_id: 1},
                       {id: 36, name: "New Mexico", abbreviation: "NM", country_id: 1},
                       {id: 37, name: "New York", abbreviation: "NY", country_id: 1},
                       {id: 38, name: "North Carolina", abbreviation: "NC", country_id: 1},
                       {id: 39, name: "North Dakota", abbreviation: "ND", country_id: 1},
                       {id: 40, name: "Northern Mariana Islands", abbreviation: "MP", country_id: 1},
                       {id: 41, name: "Ohio", abbreviation: "OH", country_id: 1},
                       {id: 42, name: "Oklahoma", abbreviation: "OK", country_id: 1},
                       {id: 43, name: "Oregon", abbreviation: "OR", country_id: 1},
                       {id: 44, name: "Palau", abbreviation: "PW", country_id: 1},
                       {id: 45, name: "Pennsylvania", abbreviation: "PA", country_id: 1},
                       {id: 46, name: "Puerto Rico", abbreviation: "PR", country_id: 1},
                       {id: 47, name: "Rhode Island", abbreviation: "RI", country_id: 1},
                       {id: 48, name: "South Carolina", abbreviation: "SC", country_id: 1},
                       {id: 49, name: "South Dakota", abbreviation: "SD", country_id: 1},
                       {id: 50, name: "Tennessee", abbreviation: "TN", country_id: 1},
                       {id: 51, name: "Texas", abbreviation: "TX", country_id: 1},
                       {id: 52, name: "Utah", abbreviation: "UT", country_id: 1},
                       {id: 53, name: "Vermont", abbreviation: "VT", country_id: 1},
                       {id: 54, name: "Virgin Islands", abbreviation: "VI", country_id: 1},
                       {id: 55, name: "Virginia", abbreviation: "VA", country_id: 1},
                       {id: 56, name: "Washington", abbreviation: "WA", country_id: 1},
                       {id: 57, name: "West Virginia", abbreviation: "WV", country_id: 1},
                       {id: 58, name: "Wisconsin", abbreviation: "WI", country_id: 1},
                       {id: 59, name: "Wyoming", abbreviation: "WY", country_id: 1}
                     ])
