...
CREATE TABLE `documents` (
  ...
  `url_hash` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `external_data_nys_disclosures` (
  ...
  `r_amend` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `swamp_tips`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `swamp_tips` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
