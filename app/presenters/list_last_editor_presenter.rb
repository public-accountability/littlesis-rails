...
class ListLastEditorPresenter
  ...
  def find_last_editor
    if last_list_edit.nil? || @list.updated_at > last_list_edit.created_at.advance(minutes: 1)
      @last_edited_at = @list.updated_at
      User.system_user
    else
