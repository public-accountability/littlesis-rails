...
module Oligrapher
  VERSION = 'fd64e09c755fb0403f4181b4c3d24679af52972b'
  ...
  def self.configuration(map:, current_user: nil)
...

    {
      ...
      attributes: {
        ...
        shareUrl: (is_owner and map.persisted?) ? Rails.application.routes.url_helpers.share_oligrapher_path(id: map.id, secret: map.secret) : nil
      } }
  end
