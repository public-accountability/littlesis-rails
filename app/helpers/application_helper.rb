module ApplicationHelper
  ...
  # This overrides the default helper generated by the rails's router
  # We are using nginx re-writing rules to change '/org' and '/person' to '/entities'
  # Therefore, for at least the concieable future, we will continue to use
  # "legacy urls" for entity show and edit pages
