...
class Link
  module Subcategory
    SUBCATEGORIES = %i[board_members board_memberships governments businesses campaign_contributions campaign_contributors children donations donors family generic holdings lobbied_by lobbies members memberships offices owners parents positions schools social staff students transactions].to_set.freeze
    # link --> text
