...
class ExtensionDefinition < ApplicationRecord
  ...
  DISPLAY_NAMES = {
    ...
    :fr => {
      ...
      7 => "Enseignement",
      8 => "Organisation par adhésion",
      9 => "Philantropie",
      10 => "Association à but non lucratif",
      11 => "Comité de campagne électoral",
      12 => "Entreprise privée",
      13 => "Etablissement public",
      14 => "Syndicat industriel/commercial",
      15 => "Cabinet d'avocat",
      16 => "Agence de lobbying",
      17 => "Agence de relations publiques",
      18 => "Comité de campagne électorale individuel",
      19 => "Comité d'Action Politique (PAC)",
      20 => "Autre comité de campagne",
      21 => "Média",
      22 => "Groupe de réflexion",
      23 => "Arts et Culture",
      24 => "Cercle privé",
      25 => "Association professionnelle",
      26 => "Parti politique",
      27 => "Syndicat salarié",
      28 => "Entreprise à financement public",
      29 => "Entrepreneur",
      30 => "Lobbyiste",
      31 => "Universitaire",
      32 => "Personnalité médiatique",
      33 => "Cabinet de consultants",
      34 => "Intellectuel public",
      35 => "Personnalité publique",
      36 => "Juriste",
      37 => "Couple",
      38 => "Institut de recherche académique",
      39 => "Organe juridictionnel et consultatif",
      40 => "Groupe de consensus d'élite"
    }.freeze
  }.freeze
