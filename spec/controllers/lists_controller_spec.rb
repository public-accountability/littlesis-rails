...
describe ListsController, :list_helper, type: :controller do
  ...
  describe 'GET /lists' do
    ...
    before do
      ...
      new_list3 = create(:list, name: 'someone else private list', access: UserPermissions::ACCESS_PRIVATE, creator_user_id: controller.current_user.id + 1)
      new_list4 = create(:list, name: 'current user private list', access: UserPermissions::ACCESS_PRIVATE, creator_user_id: controller.current_user.id)
  ...
  describe 'user not logged in' do
    before do
      ...
      @private_list = create(:list, name: 'someone else private list', access: UserPermissions::ACCESS_PRIVATE, creator_user_id: 123)
      @inc = create(:mega_corp_inc)
      ListEntity.find_or_create_by(list_id: @new_list.id, entity_id: @inc.id)
  ...
  describe "#set_permisions" do
    before do
      ...
      @list = build(:list, access: UserPermissions::ACCESS_OPEN, creator_user_id: @user.id)
