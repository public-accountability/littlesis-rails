describe Pages do
  specify do
    expect(Pages::HTML.keys).to eq %w[disclaimer terms_of_use privacy_policy cookies_notice about]
  end
  ...
  specify do
    expect(Pages.get(:cookies_notice, :en)).to eq Pages.get(:cookies_notice, :pl)
  end
end
