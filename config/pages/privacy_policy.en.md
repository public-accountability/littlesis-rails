...
* Analytics. We use self-hosted Javascript-based analytics [Matomo On-Premise](https://matomo.org/matomo-on-premise) that uses cookies and tracks users by user ID and session cookies.
